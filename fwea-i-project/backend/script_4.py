# Create backend package.json and main server file
backend_files = {}
...
backend_files['backend/package.json'] = '''{
  "name": "fwea-i-backend",
  "version": "1.0.0",
  "description": "FWEA-I Omnilingual Clean Version Editor Backend - Supporting 197 Languages",
  "main": "server.js",
  "scripts": {
...
# Main server file
backend_files['backend/server.js'] = '''const express = require('express');
...
print(f"\n📦 Created {len(backend_files)} backend core files")